...
public class ParticipantOracleUpdateProcedure extends ParticipantStoredProcedure {

	private static final String FUNCTION_NAME = "dl_gnl_par.f_upd";

	public ParticipantOracleUpdateProcedure(DataSource dataSource, StructMapperService mapperService) {
	...
	public Participant update(Participant entity, String username) {
		...
		SqlStructValue<Participant> structValue = new SqlStructValue<>(entity, mapper);
